...
const reportUrl = 'api/embedreport';
const reportListUrl = 'api/embedreport/getreportlist'
...
export { errorClass, errorElement, hidden, position, reportUrl, reportListUrl, successClass, successElement };
